...
-- Volcando estructura de base de datos para world
CREATE DATABASE IF NOT EXISTS `world` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `world`;

-- Volcando estructura para tabla world.city
...
-- Volcando datos para la tabla world.city: ~4,188 rows (aproximadamente)
DELETE FROM `city`;
...
-- Volcando estructura para tabla world.country
...
-- Volcando datos para la tabla world.country: ~239 rows (aproximadamente)
DELETE FROM `country`;
...
-- Volcando estructura para tabla world.countrylanguage
...
-- Volcando datos para la tabla world.countrylanguage: ~984 rows (aproximadamente)
